...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        "flex cursor-pointer items-center rounded-sm px-2.5 py-2 text-sm text-ink outline-none transition-colors",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      className={cn(
        "relative flex cursor-pointer items-center rounded-sm py-2 pl-8 pr-2.5 text-sm text-ink outline-none transition-colors",
        "focus:bg-neutral-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      checked={checked}
